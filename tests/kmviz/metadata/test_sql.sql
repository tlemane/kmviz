...
CREATE TABLE `table_test` (
  ...
  `Lat` tinyint(4) DEFAULT NULL,
  `Lon` tinyint(4) DEFAULT NULL
...
INSERT INTO `table_test` VALUES ('S1',1,8,10,90),('S2',2,7,20,90),('S3',3,6,30,90),('S4',4,5,40,90),('S5',5,4,50,90),('S6',6,3,60,90),('S7',7,2,70,90),('S8',8,1,80,90);
